...
supportHash = ZINKAllinone.functions.genArbitrateHash(0, lastOrderId).call()
...
sfarTxRaw = ZINKAllinone.functions.ZINKAdminDelegateSubmitFinalArbitrationResult(lastOrderId, [0, 0, 0, pOne.address, pTwo.address, pThree.address, binascii.unhexlify(v01sig[2:]), binascii.unhexlify(v02sig[2:]), binascii.unhexlify(v03sig[2:])]).buildTransaction(
    {
        'chainId': w3.eth.chain_id,
        'gas': 5 * 10 ** 6,
        'gasPrice': w3.eth.gas_price,
