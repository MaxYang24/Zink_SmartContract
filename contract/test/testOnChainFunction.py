...
print("Order Hash:", OrderHash.hex())
...
print("delegate create order:", delegateCreateOrderTxhash.hex())
time.sleep(10)

###########################
# teacher submit answer
sahash = ZINKAllinone.functions.genActionHash(
    b"submitanswer", lastOrderId).call()
...
print("teacher submits answer:", tcsubrawTxSignedTxhash.hex())
time.sleep(10)

# student accept
##############################
aahash = ZINKAllinone.functions.genActionHash(
    b"accpetanswer", lastOrderId).call()
...
print("student accepts answer:", staarawTxSignedTxhash.hex())
time.sleep(10)
